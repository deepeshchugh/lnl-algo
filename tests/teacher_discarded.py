...
class TeacherDiscarded(SmarterTeacher):
    ...
    def membership_query(self, test_word):
        ...
        for char in test_word:
            if char == 'a':
                ...
                b_count += 1
        if a_count%3 == 1 and b_count%3 == 1:
            return CONST.POS
        elif b_count%3 == 0:
            return CONST.NEG
        elif a_count%3 == 2 and b_count%3 == 1:
            return CONST.NEG
        else:
...
glp = GlpAlgorithm(alphabet=['a', 'b'], teacher=TeacherDiscarded())
